        ...
        {skills.length === 0 ? (
          ...
          <div className="space-y-16">
            {Object.entries(groupedSkills).map(([category, categorySkills]) => (
              <div key={category}>
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-left border-b border-gray-200 dark:border-gray-700 pb-2">
                        ...
                        <div className="w-12 h-12 md:w-14 md:h-14 mb-2 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 relative">
                          {skill.icon ? (
                            <img
                              src={skill.icon}
                              alt={skill.name}
                              className="w-full h-full object-contain bg-white dark:bg-gray-200 rounded-lg p-1.5 shadow-sm"
                              onError={(e) => {
